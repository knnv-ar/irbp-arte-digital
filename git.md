...
- [Configuración de nombre de usuario y correo de usuario en local](#configuración-de-nombre-de-usuario-y-correo-de-usuario-en-local)
- [Crear un proyecto nuevo en local y vincular su repositorio en Github](#crear-un-proyecto-nuevo-en-local-y-vincular-su-repositorio-en-github)
- [Crear un repositorio en GitHub y clonarlo en local](#crear-un-repositorio-en-GitHub-y-clonarlo-en-local)
...
2. La versión con la que trabajaremos es la v2.37.3 (fecha de lanzamiento: 2022-08-30)
...
### Crear un repositorio en GitHub y clonarlo en local
